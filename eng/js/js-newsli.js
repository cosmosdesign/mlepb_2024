...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        type: "POST",
        data: { 'chk_php_self': location.pathname, '_lang': "E", 'keywords': keywords, '_usergroup': _usergroup, '_class': _class, 'page': page},
        dataType: 'json',
        ...
        success: function (response) {
            ...
            if (!news_class.hasOwnProperty(_class)) {
                window.location.href = "index.html";
            }
                ...
                <article class="modNewsProList">
                    ...
                    <p class="modNewsProList-subArea">
                        ...
                        <span class="modNewsProList-subArea--date">
                            ` + (str_date_array[0]) + '-' + str_date_array[1] + '-' + str_date_array[2] + `
                        </span>
                    </p>
            ...
            $("#Total_Count").html('Total ' + news_list.total + ' Count');
            $(document).prop("title", sysconfig[19].setvalue + " - Latest news - " + news_class_str);
        }
    });
