...
$(document).ready(function() {
    ...
    $.ajax({
        ...
        type: "POST",
        data: { 'chk_php_self': location.pathname, '_lang': "E", 'nid': nid },
        dataType: 'json',
        ...
        success: function (response) {
            ...
            <a href="javascrip:void(0);" class="eleBite-link">
                Latest news<span class="icon">▶</span>
            </a>
            ...
            $.each(newsPicData, function (i, file) {
                ...
                <div class="swiper-slide modBanner-img--bigBk">
                    <img src="`+ CONFIG["Api_Domain_Path"] + 'news/' + nid + '/' + file.value +`" alt="` + file.name + ` big picture" class="modBanner-img modBanner-img--big">
                ...
                <div class="swiper-slide">
                    <img src="`+ CONFIG["Api_Domain_Path"] + 'news/' + nid + '/' + file.value +`" alt="` + file.name + `thumb picture" class="modBanner-img">
                </div>
                `
            });
            if (newspic_big_list == "") {
            ...
            $(document).prop("title", sysconfig[19].setvalue + " - Latest news - " + news_class_str + " - " + news_title);
